                  ...
                  >
                    ...
                    <div className="flex flex-col py-2 mb-2">
                      ...
                      <input
                        ...
                        className={`border px-4 py-2 ${state.error ? 'border-red-500' : ''}`}
                        placeholder="+91"
                        required="true"
                      />
                      {/* {state.error && <p className="text-red-500">Please enter a 10 digit number</p>} */}
                      {/* { state.phone.length} */}
                      {state.error ? (
                      <div className="bg-red-200 py-2 px-4 rounded mt-5">
                        {state.error}
                      </div>
                    ) : (
                      ""
                    ...
                    {
                      state.phone && state.phone.length != 10 || state.address && state.address == "" ? 
                      <div onClick={ (e) => setState({ ...state, error: "Please enter 10 Digit Number" })} className="w-full px-4 py-2 text-center text-white font-semibold cursor-pointer"
