...
const Navber = (props) => {
  ...
  return (
    <Fragment>
      {/* Navber Section */}
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white" style={{height:'70px'}}>
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-black-800 cursor-pointer"
          ...
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            ...
            <span
              ...
              className="flex items-left text-center text-darkred-800 text-2xl cursor-pointer px-2 text-center"
            >
              RedCart
            </span>
          </div>
          <div
            onClick={(e) => history.push("/")}
            style={{ color: 'darkred', fontFamily:"Georgia, serif", fontWeight:'400',textTransform:'Uppercase',fontSize:'1.8rem'}}
            className="hidden lg:block flex items-left col-span-1 text-center font-bold tracking-widest text-2xl cursor-pointer"
          >
            RedCart
          </div>
